...
interface ExploreCoursesSidebarProps {
  onUpgrade?: () => void;
}

export const ExploreCoursesSidebar: React.FC<ExploreCoursesSidebarProps> = ({ onUpgrade }) => {
        ...
        <nav className="space-y-1">
          {NAV_ITEMS.map((item) => {
            ...
            const isActive =
              ...
              (item.href === '/explore-courses' && location.pathname.startsWith('/explore'));
