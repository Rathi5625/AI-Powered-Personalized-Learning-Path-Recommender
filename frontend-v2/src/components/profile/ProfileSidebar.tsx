...
export const ProfileSidebar: React.FC<ProfileSidebarProps> = ({ onUpgrade }) => {
      ...
      <div className="space-y-6">
        ...
        <Link to="/" className="block px-2 group cursor-pointer">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[#8e4d2b] flex items-center justify-center text-white font-black text-base shadow-2xs">
              L
            </div>
            <div>
